...
int main(int argc, char *argv[])
{
	...
	gtc.addRideableOption(new HTMHashTableFactory<string>(), "HTMHashTable");
	...
	gtc.addRideableOption(new HTMGraphFactory<numVertices, meanEdgesPerVertex, vertexLoad>(), "HTMGraph");
